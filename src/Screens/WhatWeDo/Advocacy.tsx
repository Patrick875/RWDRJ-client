...
function Advocacy() {
	return (
		<AnimatePage>
			<div className="">
				<div className="flex flex-col items-center justify-center w-full h-[60vh] bg-bottom bg-cover bg-image-advocacy">
				...
				<div className="p-3 bg-primary-orange h-[60vh] flex flex-col justify-center items-center">
				...
				<div className="bg-blue-900 ">
					<div className="flex w-5/6 mx-auto h-[70vh]">
						...
						<div className="flex flex-col justify-center w-1/2 h-full py-4 text-lg">
							<p className="p-3 text-2xl text-white text-start font-lora">
					...
					<div className="flex w-5/6 mx-auto ">
						<div className="flex flex-col justify-center w-1/2 h-full px-2 py-4">
