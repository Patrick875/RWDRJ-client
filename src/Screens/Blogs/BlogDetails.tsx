	...
	return (
		<div>
			...
			{!loading && blog && (
				<div>
					<div
						className="w-full min-h-[80vh] bg-center flex flex-col bg-cover  rounded-[8px]"
					...
					{blog && (
						<div>
							...
							<div className="flex justify-center w-5/6 gap-4 pt-2 mx-auto mb-3 text-center sm:justify-stretch md:py-3 md:text-start">
